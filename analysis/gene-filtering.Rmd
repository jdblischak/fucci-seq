...
covariates <- pData(eset_filtered) %>% dplyr::select(experiment, well, concentration, raw:unmapped,
...
heatmap(r2)
heatmap3(r2, cexRow=1, cexCol=1, margins=c(8,8), ylab="technical factor")
```
