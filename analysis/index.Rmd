...
* Finializing results for when validation sample consists of random cells
    * [Selecting the top X cyclical genes in the training sample](method-train-classifiers-all.html)
    * [Learning gene annotations](method-train-classifiers-genes.html)
    * [Validation sample](method-eval.html)

* Finializing results for when validation sample consists of a random individual
    ...
    * [Validation sample](method-eval-ind.html)
