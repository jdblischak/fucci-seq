...
4. We investigated the estimated cell time against the fucci intensities and considered [relations between estimated cell time and cell cycle states of G1, S, G2](images-time-eval.html).
...
4. I used nonparametric methods to identify genes that may be cyclical along cell cycle phases, using [smash and kernel regression](npreg.html).
