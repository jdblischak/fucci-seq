...
* Using [trendfilter](method-npreg.html)
* Using [nonparametric circular regression](method-npreg-npcirc.nw.html)
* Model training: [number of geness and cyclical function fit](method-npreg-prelim-results.html)

Evaluate prediction results in terms of estimation error and compare with Seurat classification
    * [On 101 genes](method-npreg-prelim-results.html)
...
* Using [nonparametric circular regression](method-npreg-npcirc.nw.html)
* Model training
    * [methods comparison (trendfilter, npcirc.nw, npcirc.ll) and number of genes](method-npreg-prelim-results.html)
    * [proportion of variance explained and comparison with Seurat](method-npreg-training-pve.html)
