...
* Analyze the training datasets
    ...
    * Finalizing results of all classifiers and the [top X number of genes](method-train-classifiers-all.html). 
    
    
* Analyze the withheld samples
    * Evaluate the withheld samples [on the top 101 cyclical genes](method-eval-withheld-explore.html) comparing peco methods with seurat predictions.
