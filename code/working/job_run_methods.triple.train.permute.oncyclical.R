...
data_permute_training <- readRDS(file=file.path(dir, "data/results/triple_data_permute_training.rds"))
...
saveRDS(out,
        file=file.path(dir, paste0("data/results/triple_results_train_permute_oncyclical.fold.",fold,".top",ngenes,".rds")))
