...
cyclical_genes <- readRDS(file=file.path(dir, paste0(
                           "data/results/triple_alge_data_training_cyclical_genes.fold.",fold,".rds")))
...
saveRDS(out,
        file=file.path(dir, paste0("data/results/triple_alge_results_train.fold.",fold,".top",ngenes,".rds")))
