...
Y_train_normed_fold <- data_permute_training$log2cpm.quant.nonvalid[ ,fold_indices[[fold]]$train]
...
saveRDS(cyclical_genes,
        file=file.path(dir,
             paste0("data/results/data_training_cyclical_genes_permute.fold.",fold,".rds")))
