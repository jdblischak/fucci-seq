...
#  nvalid <- round(ncol(log2cpm.quant)*.15)
  ...
  saveRDS(data_training, file=paste0("data/results/triple_ind_",ind,"_data_training.rds"))
  saveRDS(data_withheld, file=paste0("data/results/triple_ind_",ind,"_data_withheld.rds"))
...
saveRDS(data_training, file="data/results/triple_data_training.rds")
saveRDS(data_withheld, file="data/results/triple_data_withheld.rds")
