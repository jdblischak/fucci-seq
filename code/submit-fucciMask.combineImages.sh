...
# plates for which wells do not have duplicated images
...
for pl in ${plates[@]}; do
  ...
  sbatch fucciMask.combineImages.sbatch ${dir_code} ${dir_images_wellId} ${dir_images_processed} ${dir_images_combined} ${dir_intensities} ${pl}
done
