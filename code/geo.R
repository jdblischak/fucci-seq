...
# 20170905-A01-NA18870.fastq.gz
#
# 2. Calculate the MD5 checksum. Save as
# <experiment>-<well>-<individual>.fastq.gz, e.g. 20170905-A01-NA18870.md5
#
#
...
dir_fq_new <- "/project2/gilad/fucci-seq/geo"
...
fastq <- args[1]
# fastq <- "/project2/gilad/fucci-seq/fastq-combined/20170905/20170905-A01.fastq.gz"
