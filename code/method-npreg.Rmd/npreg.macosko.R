...
#sig.genes <- readRDS("/project2/gilad/joycehsiao/fucci-seq/output/npreg-trendfilter-quantile.Rmd/out.stats.ordered.sig.476.rds")
macosko <- readRDS("/project2/gilad/joycehsiao/fucci-seq/data/cellcycle-genes-previous-studies/rds/macosko-2015.rds")
expr.sig <- log2cpm.quant.nonvalid[rownames(log2cpm.quant.nonvalid) %in% macosko$ensembl, ]
